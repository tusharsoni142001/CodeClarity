...
class MRDocumentationRequest(BaseModel):
    ...
    # source_branch: str = Field(..., description="Source branch of the merge request")
    ...
    source_branch: Optional[str] = Field(default=None, description="Source branch of the merge request")
    project_name: Optional[str] = Field(default=None, description="Name of the GitLab project")
